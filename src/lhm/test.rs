#[cfg(test)]
mod test{
    use crate::lhm::{LinkedHashMap, Entry, Iter, IterMut, IntoIter, Keys, Values};
    ...
    fn test_send_sync() {
        ...
        is_send_sync::<Iter<u32, i32>>();
        is_send_sync::<IterMut<u32, i32>>();
        is_send_sync::<IntoIter<u32, i32>>();
        is_send_sync::<Keys<u32, i32>>();
        is_send_sync::<Values<u32, i32>>();
    }
}